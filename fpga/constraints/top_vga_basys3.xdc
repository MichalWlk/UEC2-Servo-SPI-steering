...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {JSTK2_SS}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_SS}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {JA[1]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {JSTK2_MISO}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_MISO}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {JSTK2_SCLK}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_SCLK}]
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {JSTK2_SS_X}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_SS_X}]
##Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports {JSTK2_MISO_X}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_MISO_X}]
##Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {JSTK2_MISO_X}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JSTK2_MISO_X}]
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {JSTK2_SCLK_X}]
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {PROX_FL}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PROX_FL}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {PROX_FR}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PROX_FR}]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {PROX_RL}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PROX_RL}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {PROX_RR}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PROX_RR}]
##Sch name = JC7
